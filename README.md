...
La _notebook_ [`Clusters`](https://github.com/datos-Fundar/fragmentacion_en_el_estado/blob/main/Clusters.ipynb) aborda la identificación de superposiciones y la visualización de los clusters obtenidos.
